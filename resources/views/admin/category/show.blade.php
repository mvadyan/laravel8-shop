...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            @php
            if ($category->image) {
                   $url = \Illuminate\Support\Facades\Storage::disk('public')->url('catalog/category/image/' . $category->image);
               } else {
                   $url = \Illuminate\Support\Facades\Storage::disk('public')->url('catalog/category/image/default.png');
               }
            @endphp
